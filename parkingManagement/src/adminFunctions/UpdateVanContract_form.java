 ...
 */
public class UpdateVanContract_form extends javax.swing.JFrame {

    /**
     * Creates new form UpdateCarContract_form
     */
    public UpdateVanContract_form() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("UPDATE VAN CONTRACT");
    ...
    private void kButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton2ActionPerformed
        ...
        if(choice == JOptionPane.YES_OPTION){
            ...
            double load = Double.parseDouble(jTextField4.getText());
            ...
            try {
                UpdateMySQL.updateVanContract(van, vanContract);
            } catch (ParseException ex) {
                Logger.getLogger(UpdateVanContract_form.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void kButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton1ActionPerformed
        // TODO add your handling code here:
        if(SelectMySQL.checkVan(jTextField1.getText()) == 1){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateVanContract_form.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
