 ...
 */
public class AddVanContract_form extends javax.swing.JFrame {

    /**
     * Creates new form addCarContract_form
     */
    public AddVanContract_form() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ADD VAN CONTRACT");
    ...
    private void kButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton1ActionPerformed
        try {
            ...
            float load = Float.parseFloat(jTextField4.getText());
            String dayIn = jTextField5.getText();
            String dayOut = jTextField7.getText();
            
            //create object and insert to SQL
            Van van = new Van(ownerName, numberPlate, brand);
            VanContract vanContract = new VanContract(numberPlate, load, dayIn, dayOut);
            InsertMySQL.insertVan(ownerName, numberPlate, brand);
            InsertMySQL.insertVanContract(vanContract);
            JOptionPane.showMessageDialog(null, "OK");
            dispose();
            new AdminFunction_form().setVisible(true);
        } catch (ParseException ex) {
            Logger.getLogger(AddVanContract_form.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddVanContract_form.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
